...
const uint8_t PIN_STEER_HALL_A = 30;
const uint8_t PIN_STEER_HALL_B = 31;
const uint8_t PIN_BRAKE_HALL_A = 32;
const uint8_t PIN_BRAKE_HALL_B = 33;
...
void setup() {
  ...
  Serial.println("BT on Serial1 @ 9600");
